...
class TestMenu(FlaskTestCase):
    ...
    @skipIf(
        ...
        or sys.version_info == (3, 4, 1, "final", 0),
    ...
    def test_active_item(self):
        ...
        with self.app.test_client() as c:
            ...
            c.get("/sub1/item1")
            self.assertEqual(
                current_menu.active_item, current_menu.submenu("root.sub1.item1")
            )
    ...
    def test_external_url(self):
        ...
        self.assertRaises(
            TypeError, item1.register, endpoint="test", text="Test", external_url=url
        )
    ...
    def test_has_visible_child(self):
        ...
        @register_menu(self.app, "one.four", "One Four", visible_when=lambda: False)
        ...
        # This item should never be visible.
        @register_menu(self.app, "six.seven", "Six Seven", visible_when=lambda: False)
                ...
                for endpoint, visible_should in v.items():
                    ...
                    self.assertEqual(
                        ...
                        "visible_is={2} visible_should={3}".format(
                            path, endpoint, visible_is, visible_should
                        ),
                    )
