...
from flask_menu import FlaskMenu, current_menu, register_menu
...
def test_simple_app(app):
    ...
    @app.route("/level3")
    @register_menu(app, "level2.level3", "Level 3", order=2)
    def level3():
        return "level3"
...
def test_kwargs_override(app):
    ...
    @app.route("/test")
    @register_menu(app, "test", "Test", url="/test")
    def test():
        pass
